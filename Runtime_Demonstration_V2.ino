...
//    analogWrite(motorPin2, powerMode); // Start with module off
...
//        printf( "Flux:%05i ",   lidarLeftFlux);   // display signal strength/quality,
//        printf( "Temp:%2i%s",  lidarLeftTemp, "C");   // display temperature,
//        printf( "\r\n");                   // end-of-line.
      }
...
//      {
//        printf( "Dist:%04icm ",  lidarRightDist);   // display distance,
//        printf( "Flux:%05i ",   lidarRightFlux);   // display signal strength/quality,
//        printf( "Temp:%2i%s",  lidarRightTemp, "C");   // display temperature,
//        printf( "\r\n");                   // end-of-line.
//      }
//      else                  // If the command fails...
//      {
