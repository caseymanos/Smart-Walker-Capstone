...
*/
int minDist[5] = {56, 87, 54, 54, 90};
int maxDist[5] = {84, 101, 133, 75, 117};
...
void ToFSensorCalls() {
  //Left sensor call
  leftTof.read();
  leftDistances[1] = 10 + movingAverage(leftTofIndex, leftTofAverage, leftTofSum, (leftTof.ranging_data.range_mm) / 10, leftTofReadings, WINDOW_SIZE);
